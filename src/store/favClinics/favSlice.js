...
const AddFavClinic = createAsyncThunk(
  "favClinic/AddFavClinic",
  async (id, { rejectWithValue }) => {
    try {
      const response = await apiAuthenticate.post(
        `/places/clinic/doctor/add/favdoctor/${id}`
      );
...
const DeleteFavClinic = createAsyncThunk(
  "favClinic/DeleteFavClinic",
  async (id, { rejectWithValue }) => {
    try {
      const response = await apiAuthenticate.post(
        `/places/clinic/doctor/add/favdoctor/${id}`
...
const GetFavClinic = createAsyncThunk(
  "favClinic/GetFavClinic",
  async (_, { rejectWithValue }) => {
    try {
      const response = await apiAuthenticate.get(
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(DeleteFavClinic.fulfilled, (state, action) => {
        state.loading = "success";
        state.favClinic = state.favClinic.filter(
